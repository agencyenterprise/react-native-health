    ...
    HKObserverQuery* query = [
        ...
        updateHandler:^(HKObserverQuery* query,
                        ...
                        NSError * _Nullable error) {
                            ...
                            [self emitEventWithName:successEvent body:type];
              ...
              hasListeners:(bool)hasListeners
{
    HKObserverQuery* query = [
        ...
        updateHandler:^(HKObserverQuery* query,
                        ...
                        NSError * _Nullable error) {
                            ...
                            NSString *successEvent = self.isLegacyBackgroundImplementation ? [NSString stringWithFormat: @"healthKit:%@:new", type] : @"healthKit:new";
                            NSString *failureEvent = self.isLegacyBackgroundImplementation ? [NSString stringWithFormat:@"healthKit:%@:failure", type] : @"healthKit:failure";
                            ...
                            if (error) {
                                ...
                                if(self.hasListeners) {
                                    [self emitEventWithName:failureEvent body:type];
                                }
                                return;
                            }
    ...
    [self.healthStore enableBackgroundDeliveryForType:sampleType
                                            frequency:HKUpdateFrequencyImmediate
                                       withCompletion:^(BOOL success, NSError * _Nullable error) {
        NSString *successEvent = self.isLegacyBackgroundImplementation ? [NSString stringWithFormat:@"healthKit:%@:setup:success", type] : @"healthKit:setup:success";
        NSString *failureEvent = self.isLegacyBackgroundImplementation ? [NSString stringWithFormat:@"healthKit:%@:setup:failure", type] : @"healthKit:setup:failure";
