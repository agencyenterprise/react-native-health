...
public enum QuantityType: String, HealthKitType {
    public var type: HKSampleType {
        if #available(iOS 15.0, *) {
            ...
            return HKQuantityType.quantityType(forIdentifier: .init(rawValue: hkQuantityTypePrefix + self.rawValue))!
        }
    }
    ...
    // Continuous
    @available(iOS 13.0, *)
    case EnvironmentalAudioExposure // Pressure,                    DiscreteEquivalentContinuousLevel
